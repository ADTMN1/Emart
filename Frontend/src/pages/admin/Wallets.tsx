...
export const AdminWallets: React.FC = () => {
  ...
  return <div className="space-y-6">
    <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
      ...
      <Button size="lg" onClick={() => openForm()}><Plus className="mr-2 h-4 w-4" />Add wallet</Button>
    </div>
    ...
    {wallets.length === 0 ? <Card><CardContent className="p-12 text-center"><WalletCards className="mx-auto h-10 w-10 text-muted-foreground" /><p className="mt-4 font-semibold">No wallets configured</p><p className="mt-1 text-sm text-muted-foreground">Add an active receiving wallet to make crypto checkout available.</p><Button className="mt-5" onClick={() => openForm()}><Plus className="mr-2 h-4 w-4" />Add wallet</Button></CardContent></Card> :

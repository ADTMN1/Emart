          ...
          <Card>
            <CardContent className="p-5 flex items-center gap-3 border-b border-border/60">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="text-xs text-muted-foreground truncate">john.doe@email.com</div>
          ...
          <Card>
            <CardContent className="p-0">
              ...
              <div className="p-2 border-t border-border/60">
                <button className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-destructive hover:bg-destructive/5 transition-colors">
                ...
                <Card className="md:col-span-2">
                  <CardContent className="p-5 lg:p-6">
                    ...
                    <div className="grid sm:grid-cols-2 gap-5">
                      {[
                        { l: 'Full Name', v: 'John Doe', i: User },
                        { l: 'Email Address', v: 'john.doe@email.com', i: Mail, verified: true },
                        { l: 'Phone Number', v: '+1 (555) 123-4567', i: Phone, verified: true },
                        { l: 'Country', v: '🇺🇸 United States', i: Globe2 },
                        { l: 'Member Since', v: 'March 2023', i: CalendarDays },
